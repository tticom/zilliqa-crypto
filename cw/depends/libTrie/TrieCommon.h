 ...
 * @date 2014
 */
// adapted from https://github.com/ethereum/cpp-ethereum/blob/develop/libdevcore/TrieCommon.h

#ifndef __TRIECOMMON_H__
#define __TRIECOMMON_H__
