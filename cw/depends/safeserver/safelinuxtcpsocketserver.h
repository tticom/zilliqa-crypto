...
#ifndef JSONRPC_CPP_SAFELINUXTCPSOCKETSERVERCONNECTOR_H_
#define JSONRPC_CPP_SAFELINUXTCPSOCKETSERVERCONNECTOR_H_
...
namespace jsonrpc
{
	/**
         ...
         */
    class SafeLinuxTcpSocketServer: public AbstractServerConnector
	{
		public:
			/**
                         * @brief SafeLinuxTcpSocketServer, constructor of the Linux/UNIX implementation of class TcpSocketServer
                         ...
                         */
			SafeLinuxTcpSocketServer(const std::string& ipToBind, const unsigned int &port);
                        /**
		...
		private:
			...
			{
				SafeLinuxTcpSocketServer *instance;
				int connection_fd;
...
#endif /* JSONRPC_CPP_SAFELINUXTCPSOCKETSERVERCONNECTOR_H_ */
