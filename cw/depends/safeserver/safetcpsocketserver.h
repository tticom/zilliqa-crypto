...
#ifndef JSONRPC_CPP_SAFETCPSOCKETSERVERCONNECTOR_H_
#define JSONRPC_CPP_SAFETCPSOCKETSERVERCONNECTOR_H_
#include <string>
...
namespace jsonrpc
{
	/**
         ...
         */
	class SafeTcpSocketServer: public AbstractServerConnector
	{
		public:
			/**
                         * @brief SafeTcpSocketServer, constructor for the included SafeTcpSocketServer
                         * 
                         ...
                         */
			SafeTcpSocketServer(const std::string& ipToBind, const unsigned int &port);
			/**
                         * @brief ~SafeTcpSocketServer, the destructor of SafeTcpSocketServer
                         */
			~SafeTcpSocketServer();
                        /**
...
#endif /* JSONRPC_CPP_SAFETCPSOCKETSERVERCONNECTOR_H_ */
